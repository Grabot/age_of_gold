...
// ff3881
class TileWildStrawberry extends Tile {
  TileWildStrawberry(super.q, super.r, super.tileType, super.tileQ, super.tileR);

  @override
  updateBaseTile(SpriteBatch baseBatch, int rotate) {
    baseBatch.add(
        source: tileWildStrawberry1,
